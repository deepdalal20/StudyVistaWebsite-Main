...
const HeroSection: React.FC<HeroSectionProps> = ({ onGetStarted }) => {
  ...
  const decorElements = [
    { top: '15%', left: '10%', size: isMobile ? 20 : 30, delay: 0, rotate: 0 },
    { top: '70%', left: '15%', size: isMobile ? 15 : 20, delay: 0.5, rotate: 45 },
    { top: '20%', right: '15%', size: isMobile ? 18 : 25, delay: 1, rotate: 30 },
    { top: '75%', right: '10%', size: isMobile ? 25 : 35, delay: 1.5, rotate: 60 },
  ];

  return (
    <section ref={heroRef} className="hero" style={heroStyle} id='hero'>
      <div
        className="container"
        style={{
          ...containerStyle,
          ...
          padding: isMobile
            ...
            : isTablet
            ? '0 clamp(1.5rem, 3vw, 2rem)'
            : '0 clamp(2rem, 2vw, 3rem)',
          maxWidth: '1400px',
          margin: '0 auto',
        }}
      >
        ...
        >
          ...
          >
            <span style={{ color: 'var(--secondary)', WebkitTextFillColor: 'var(--secondary)' }}>
              Transform
            </span>{' '}
            Your Future with International Education
          </motion.h1>
          ...
          >
            Unlock your potential with our expert guidance. We help students achieve their dreams of
            studying abroad with personalized counseling and support at every step of your journey.
          </motion.p>
          ...
          >
            ...
            <motion.div
              style={{
                ...
                padding: isMobile
                  ? 'clamp(0.5rem, 2vw, 0.75rem) clamp(1rem, 4vw, 1.5rem)'
            ...
            >
              <Link
                ...
                role="button"
                tabIndex={0}
                aria-label="Get Started with International Education"
              >
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: isMobile ? '0.7rem' : '0.8rem', opacity: 0.8 }}>
        ...
        {isMobile ? (
          <motion.div
            className="hero-image-container-mobile"
            style={{
              width: '100%',
              maxWidth: '400px',
              margin: '0 auto',
